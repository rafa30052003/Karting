...
public class util {
	 ...
	 */
	 public static String leeString(String mensaje) {
	  ...
	  /**
	   * Metodo que valida si la edad introducida es un caracter entero ademas de que este comprendida entre ciertas edades
	   * @param mensaje: cadena que le muestras al usuario.
	   * @return: la edad vaildada.
	   */
		  ...
		  do {
			try {
				...
				if(result >= 16) {
					...
					System.out.println("usted debe ser mayor de 16 años");
